    ...
    public partial class @base : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1aa66381-d97f-4bbf-ab23-982937f1b514"), new DateTime(2022, 5, 7, 11, 52, 43, 454, DateTimeKind.Local).AddTicks(2213), "Triggered when reservation is updated.", "Reservation Updated", "reservation.updated" },
                    { new Guid("1be8560f-2270-470a-8825-088a7470ca32"), new DateTime(2022, 5, 7, 11, 52, 43, 454, DateTimeKind.Local).AddTicks(2207), "Triggered when reservation is canceled.", "Reservation Canceled", "reservation.canceled" },
                    { new Guid("d2e7a506-119a-4715-ad3d-c16ab3ae569c"), new DateTime(2022, 5, 7, 11, 52, 43, 454, DateTimeKind.Local).AddTicks(2136), "Triggered when reservation is created.", "Reservation Created", "reservation.created" }
                });

            migrationBuilder.InsertData(
                table: "WebhookSubscriptions",
                columns: new[] { "Id", "Created", "DisplayName", "IsActive", "PayloadUrl", "Secret" },
                values: new object[] { new Guid("c55dfd4c-52d2-4fa4-a4f4-46aa89dfd0fe"), new DateTime(2022, 5, 7, 11, 52, 43, 454, DateTimeKind.Local).AddTicks(2542), null, true, "http://45.85.146.19:999/webhook", "secret" });
